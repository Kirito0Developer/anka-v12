...
client.on("guildMemberAdd", member => {
  ...
  if (ayyy < 1) {
    kontrol = "**Şüpheli** <a:asgard_carpi:940279357505671228>";
  }
  if (ayyy > 1) {
    kontrol = "**Güvenilir** <a:asgard_hawli_pikacu:940286256238166056>";
  }
...
//-------------------- Mod Log Sistemi --------------------//
 ...
 //
  .setDescription(`<a:asgard_pikacu:940322964161839187> **Hoş geldin!** ${
        member.user
      }, seninle beraber **${
        guild.memberCount
      }** kişi olduk! \n <a:asgard_developer:940284790865789018> Kaydının yapılması için **isim** ve **yaş** yazman gerek. \n <:asgard_kalkan:939961737296347197> Hesap kuruluş tarihi: **${moment(
        user.createdAt
      ).format("DD")} ${aylar[moment(user.createdAt).format("MM")]} ${moment(
        user.createdAt
      ).format(
        "YYYY HH:mm:ss"
       )}** \n <a:asgard_kalp:940286789292273664> Bu vatandaş: ${kontrol} \n <a:asgard_siyah_elmas:940283807460913172> <@&${kayıtçı}> rolündeki yetkililer sizinle ilgilenecektir.`);
  //
...
client.on("message", async msg => {
  ...
  let seviyeEmbed = new Discord.MessageEmbed()
   ...
   seviyeEmbed.setDescription(`Tebrik ederim <@${msg.author.id}>! Seviye atladın ve **${lvl+1}** seviye oldun! <a:asgard_kirmizi_tac:940283560881971210>`)
 ...
 kanal.send(new Discord.MessageEmbed()
   ...
   .setDescription(`Tebrik ederim <@${msg.author.id}>! Seviye atladın ve **${lvl+1}** seviye oldun <a:asgard_kirmizi_tac:940283560881971210>`)
...
client.on('message', async message => {
  ...
  srol.forEach(async rols => {
    ...
    if(message.content == 's*seviyerolleri' || message.content == "a!levelroles") {
...
db.set(`goldzzz_${msg.author.id}`, Date.now());
  ...
  .setDescription(`
  ╔════════════════════════════
  ║ <a:asgard_developer:940284790865789018>
  ║ <a:asgard_kirmizi_tac:940283560881971210> **Sahibim Burada Aç Yolu**! <@${msg.author.id}>
  ║ <:asgard_rozet2:939967826301693962>
  ╚════════════════════════════`)
  .setColor("#f6ff00")
...
client.on("message", msg => {
    ...
    .setThumbnail(msg.author.displayAvatarURL({dynamic : true}))
    .setColor('#f6ff00')
    .setTitle("▬▬▬▬[<:asgard_kalkan:939961737296347197> Yardım Mesajım <a:asgard_zil:940283910527520838>]▬▬▬▬\n ")
    .addField("\n**Galiba Benden Yardım İstiyorsun ? O zaman Sana Yardım Edeyim.**\n","**\n`a!yardım` Yazarak Benim `Tüm Komutlarımı Görebilirsin` ve Aşşağıdaki `Destek Sunucusuna Gelerek Botun Sahibinden Yardım Alabilirsin.`**")
    .addField("**➥ Link**", "[<a:asgard_kirmizi_tac:940283560881971210> Destek Sunucu](https://discord.gg/zRfXkcdtUY)")
    .setImage("https://cdn.discordapp.com/attachments/939889661990535286/940904734477398036/standard.gif")
...
.setColor('#f6ff00')
.setDescription(`<a:auralion_sari_tac:940904306884886568> ${member} **Adlı Kullanıcı Sunucumuza Katıldı** \n**Onu Davet Eden Kişi** : ${daveteden}\n**${daveteden} Kişinin Toplam Davet Sayısı** : ${davetsayi}`)
...
client.on("guildMemberRemove", async member => {
  ...
  if (!davetçi) {
    return client.channels.cache.get(kanal).send(`<a:auralion_sari_tac:940904306884886568> ${member} **Adlı Kullanıcı Aramızdan Ayarıldı Davet Eden Bulunamadı!**`);
  } else {
     
const davet = new Discord.MessageEmbed()
.setTitle('Aramızdan Ayrıldı')
.setColor('#f6ff00')
.setDescription(`<a:auralion_sari_tac:940904306884886568> ${member} Adlı Kullanıcı Sunucumuzdan Ayrıldı \n**Onu Davet Eden Kişi** : ${daveteden}\n**${daveteden} Kişinin Toplam Davet Sayısı** : ${davetsayi}`)
client.channels.cache.get(kanal).send(davet)  
      }
    }
);
...
if(Date.now() < maxTime) {
  ...
  .setColor('#f6ff00')
  .setDescription(`<a:asgard_nike:940320433876639814> <@${message.author.id}> , **Bu Sunucuda Spam Yapmana İzin Vermeyeceğim!**`)
...
let kanal = await db.fetch(`antiraidK_${member.guild.id}`)== "anti-raid-aç"
  ...
  if (member.user.bot === true) {
    ...
    let are = new Discord.MessageEmbed()
      ...
      .setDescription(`**${member.user.tag}** (${member.id}) adlı bota bir yetkili izin verdi eğer kaldırmak istiyorsanız **a!bot-izni kaldır <BotID>**.`);
    cod.send(are);
     } else {
       let izinverilmemişbot = new Discord.MessageEmbed()
      .setColor('#f6ff00')
      .setThumbnail(member.user.avatarURL())
      .setDescription("**" + member.user.tag +"**" + " (" + member.id+ ") " + "adlı bot sunucuya eklendi ve Kickledim. Eğer izin vermek istiyorsanız ** **a!bot-izni ver <BotID>**")//NWA
...
client.on('guildMemberAdd', member => {
 ...
 member.roles.add(member.guild.roles.cache.get(rol))
    ...
    .setDescription('>  <:asgard_kirmizi_galp:939958901175091233> **<@' + member.user.id+  '>** **Adlı Kullanıcı Aramıza Katıldı** \n> **Kullanıcısına Başarıyla** <@&' + rol + '> **Rolü verildi**')
    .setColor('#f6ff00')    //.setFooter(`<@member.id>`)
    .setFooter('Anka Botu Tercih Ettiğiniz İçin Teşekkür Ederiz.')
...
.addField( `***╭−−−−−−−−−−− \`『 °Anka Sayaç° 』\` −−−−−−−−−−−−╮ ***`,
    `
**┊** <a:auralion_hg:940905979615272982> **${member}** Sunucuya Katıldı
**┊** <a:auralion_hg:940905979615272982> **${sayac}** Kişi Olmamıza **${sayac - member.guild.memberCount}** Kişi Kaldı
**┊** <a:auralion_hg:940905979615272982> Toplam **${member.guild.memberCount}** Kişiyiz !
**╰−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−╯**
  `)
  skanal31.send(geldi)
});
...
.addField( `***╭−−−−−−−−−−− \`『 °Anka Sayaç° 』\` −−−−−−−−−−−−╮ ***`,
    `
**┊** <a:asgard_kirik_kalp:940284635512967218> **${member}** Sunucudan Ayrıldı
**┊** <a:asgard_kirik_kalp:940284635512967218> **${sayac}** Kişi Olmamıza **${sayac - member.guild.memberCount}** Kişi Kaldı
**┊** <a:asgard_kirik_kalp:940284635512967218> Toplam **${member.guild.memberCount}** Kişiyiz !
**╰−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−╯**
   `)
  skanal31.send(gitti)
});
...
client.on("guildMemberAdd", async member => {
let frenzy_ibrahim = await db.fetch(`Anka?Bot?Ototag_${member.guild.id}`) 
let frenzykanal = await db.fetch(`Anka?Bot?OtotagKanal_${member.guild.id}`)
if(!frenzy_ibrahim || !frenzykanal) return
  
  var embed2 = new Discord.MessageEmbed()
  .setThumbnail(member.user.displayAvatarURL({dynamic : true}))
    .setColor("#f6ff00")
    .setAuthor("Anka Bot | Ototag Sistemi")
    .setDescription(
      `**${member.user.username}** Adlı Kullanıcıya Başarıyla **${frenzy_ibrahim}** Tagı'nı Verdim <a:asgard_tik:940279602272673792>`
          );
...
let embed = new Discord.MessageEmbed()
var botOwnerID = "683707976468398227";
...
const embed = new Discord.MessageEmbed() .setColor('#f6ff00') .setDescription(`<a:asgard_basetxd:940321639017619506> ${nev.author} , **Mesajını editleyerek reklam yapmaya çalıştı!**`)
      .addField("Mesajı:",nev)
  
      nev.delete();
      const embeds = new Discord.MessageEmbed() .setColor('#f6ff00') .setDescription(`<a:asgard_basetxd:940321639017619506> ${nev.author} , **Mesajı editleyerek reklam yapamana izin veremem!**`) 
...
msg.delete({timeout:750});
              const embeds = new Discord.MessageEmbed() .setColor('#f6ff00') .setDescription(`<:asgard_rozet1:939967789261795379> <@${msg.author.id}> , **Bu sunucuda reklam yapmak yasak!**`)
msg.channel.send(embeds).then(msg => msg.delete({timeout: 5000}));
                     db.add(`reklam_${msg.guild.id}_${msg.author.id}`, 1)

          const embed = new Discord.MessageEmbed() .setColor('#f6ff00') .setDescription(`<a:asgard_basetxd:940321639017619506> ${msg.author} , **Reklam yapmaya çalıştı!**`) .addField("Mesajı:",msg)
         client.channels.cache.get(y).send(embed)
            }              
          } catch(err) {
            console.log(err);
    ...
    if (kufur.some(word => msg.content.toLowerCase().includes(word))) {
      if (!msg.member.hasPermission("ADMINISTRATOR")) {
        ...
        var k = new Discord.MessageEmbed()
          ...
          .setDescription(
            `Hey <@${msg.author.id}>, Bu sunucuda küfürler **${client.user.username}** tarafından engellenmektedir! Küfür etmene izin vermeyeceğim! <a:asgard_basetxd:940321639017619506>`
          );
...
client.on('message', async (msg, member, guild) => {
  let i = await  db.fetch(`saas_${msg.guild.id}`)
      if(i === 'açık') {
        ...
        .addField('Aleykum Selam Hoşgeldin İyi misin ?','İnşallah İyisindir. <a:asgard_pikacu:940322964161839187>')
...
client.on('message', async (msg, member, guild) => {
  let i = await  db.fetch(`saas_${msg.guild.id}`)
      if(i === 'açık') {
        ...
        msg.reply('**Hi welcome <a:asgard_pikacu:940322964161839187>**').then(a=>a.delete({timeout:10000})); 
      }
      }
    });
...
client.on('message', async (msg, member, guild) => {
  let i = await  db.fetch(`saas_${msg.guild.id}`)
      if(i === 'açık') {
        ...
        .setColor('#f6ff00')
        .setFooter(`${msg.author.tag} İyi Olmana Sevindim. <:asgard_kirmizi_galp:939958901175091233>`, msg.author.avatarURL())
        .addField('Ohhh Ne Güzel! <:asgard_kirmizi_galp:939958901175091233>','Allah Dahada İyilik Versin. <:asgard_kirmizi_galp:939958901175091233>')
...
client.on('message', async (msg, member, guild) => {
  let i = await  db.fetch(`saas_${msg.guild.id}`)
      if(i === 'açık') {
        ...
        .setColor('#f6ff00')
        .setFooter(`${msg.author.tag} Kötü Olmana Üzüldüm. <a:asgard_sad:940286666009100308>`, msg.author.avatarURL())
        .addField('Senin Adına Üzüldüm. <a:asgard_sad:940286666009100308>','Allah İyilik Versin Patron. Seviliyorsun Unutma <a:asgard_sad:940286666009100308>')
...
///////////////////////OtoCevap////////////////////////////
client.on("message", msg => {
  if (msg.content.toLowerCase() === "anka") {
    const oto = new Discord.MessageEmbed()
    .setThumbnail(msg.author.displayAvatarURL({dynamic : true}))
    .setColor('#f6ff00')
    .setTitle("▬▬▬▬[<:asgard_rozet1:939967789261795379> Yardım Mesajım <:asgard_rozet1:939967789261795379>]▬▬▬▬\n ")
    .addField("\n**Galiba Benden Yardım İstiyorsun ? O zaman Sana Yardım Edeyim.**\n","**\n`a!yardım` Yazarak Benim `Tüm Komutlarımı Görebilirsin` ve Aşşağıdaki `Destek Sunucusuna Gelerek Botun Sahibinden Yardım Alabilirsin.`**")
    .addField("**➥ Link**", "[<a:auralion_sari_tac:940904306884886568> Destek Sunucu](https://discord.gg/dkV6zHT56z)")
    .setImage("https://cdn.discordapp.com/attachments/939889661990535286/940904734477398036/standard.gif")
    .setFooter(`${msg.author.username} Yardım Edebildiysem Çok Mutluyum. <a:asgard_tik:940279602272673792>`, msg.author.avatarURL())
...
client.on("ready", () => {
  console.log(`UPTİME SİSTEMİ BAŞARIYLA ÇALIŞIYOR / ANKA BOT`)
})
...
client.on("message", message => {
  ...
  fetch(link).then(() => {
    let yardım = new Discord.MessageEmbed()
        ...
        .setColor('#f6ff00')
        .setDescription("**<a:asgard_tik:940279602272673792> Başarılı! Projeniz artık 7/24!**")
    ...
    let yardım = new Discord.MessageEmbed()
        .setAuthor(client.user.username)
        .setColor('#f6ff00')
        .setDescription("**<a:asgard_carpi:940279357505671228> Hata! Sadece düzgün url'ler ekleyebilirsiniz.**")
        .setFooter(`© ${client.user.username}`)
        .setTimestamp()
...
if(message.author.bot) return;
if(message.content.startsWith('a!afk')) return;
if(message.mentions.members.first()) {
let mention = message.mentions.members.first();
const est = await db.fetch(`kullanıcı.${mention.id}.${message.guild.id}`);
if(est) {
message.channel.send(new Discord.MessageEmbed().setThumbnail(mention.user.avatarURL() ? mention.user.avatarURL({dynamic: true}) : 'https://cdn.discordapp.com/attachments/939889661990535286/940976109590286336/Free-Download-Phoenix-Wallpaper-HD-for-PC.jpg')
...
log.send(new Discord.MessageEmbed()
.setTitle('Anka Bot - TAG Çıkarıldı.')
.setColor('#f6ff00')
